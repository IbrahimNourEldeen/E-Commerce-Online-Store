    ...
    <div className="mt-5 p-5 border border-gray-300 rounded-md w-[25%]">
      ...
      <form onSubmit={handleSubmit}>
        <div className="max-w-sm mx-auto">
          ...
          <div
            className={`flex items-center border-gray-300 rounded-md px-3 py-2 shadow-sm ${
        ...
        <div className="text-sm">
          ...
          <button className="mt-2 text-blue-700 hover:underline hover:text-blue-900 font-semibold">
            Need help?
          </button>
        </div>
      </form>
